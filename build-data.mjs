#!/usr/bin/env node
/* eslint-env node */
// Generiert sixpackData.generated.js aus dem lokalen Katalog.
// catalog/6pack/ + catalog/calisthenics/ sind die Datenquelle,
...
const SIXPACK_DIR = join(REPO_ROOT, 'catalog/6pack');
const CALISTHENICS_DIR = join(REPO_ROOT, 'catalog/calisthenics');
const OUT_FILE = join(REPO_ROOT, 'sixpackData.generated.js');
...
// Quelle: catalog/6pack/ + catalog/calisthenics/.
